...
extension CGSize {
    public static let a4 = CGSize(width: 8.25 * .pointsPerInch, height: 11.75 * .pointsPerInch)
}

extension NSAttributedString {
    func pdf(size: CGSize = .a4, inset: CGSize = .init(width: .pointsPerInch, height: .pointsPerInch)) -> Data {
